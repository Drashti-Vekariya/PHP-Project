...
// Check if the search data is set
if (isset($_POST['searchdata'])) {
    $searchdata = mysqli_real_escape_string($con, $_POST['searchdata']); // Escape special characters for SQL
} else {
...
if (isset($_GET['del'])) {
    $nid = $_GET['id'];
    mysqli_query($con, "DELETE FROM tblnotes WHERE id ='$nid'");
    mysqli_query($con, "DELETE FROM tblnoteshistory WHERE noteId ='$nid'");
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Search Result Against "<?php echo htmlspecialchars($searchdata); ?>"</h1>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
<?php 
$query = mysqli_query($con, "SELECT * FROM tblnotes WHERE noteTitle LIKE '%$searchdata%'");
$cnt = 1;
